...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/style/css/vendor/hamburger-menu.css">
...
<body>
    <header>
        <section class="nav">
            <img class="nav-logo" src="<?php echo get_template_directory_uri(); ?>/images/img-site-logo_202107.gif" alt="">
            <!-- ハンバーガーメニュー -->
            ...
            <nav class="hamburger-nav">
                <ul class="nav-list">
                    <li class="list-detail"><a class="link" href="#">会社概要</a></li>
                    <li class="list-detail"><a class="link" href="#">ミッション</a></li>
                    <li class="list-detail"><a class="link" href="#">ニュース</a></li>
                    <li class="list-detail"><a class="link" href="#">サービス</a></li>
                    <li class="list-detail"><a class="link" href="#">IR</a></li>
                    <li class="list-detail"><a class="link" href="#">採用情報</a></li>
                    <li class="list-detail"><a class="link" href="#">パートナー</a></li>
                </ul>
            </nav>
        </section><!-- nav -->
        <section class="top">
            ...
            <div class="top-item">
                <div class="top-title">スモールビジネスを、<br>世界の主役に。</div>
